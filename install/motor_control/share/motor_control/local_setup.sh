...
: ${AMENT_CURRENT_PREFIX:="/home/tanawatp/BaLEGce/balegce_ws/install/motor_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/motor_control/environment/pythonpath.sh"
